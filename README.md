...
By default, these keyspaces are configured to use the simple replication strategy (`'class' : 'SimpleStrategy'`)
...
creation statements to prevent accidental lost of data.
