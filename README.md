...
It is easy to restart the entire service using Docker Compose commands, for example to pick up new versions of the 
Docker images. Keep in mind that the database will remain unchanged, so that the new service can continue to work with 
old data.
