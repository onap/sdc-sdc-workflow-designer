...
import Select from 'shared/componenets/Select/index';
import { VERSION_LEVEL_LIST } from 'src/appConstants';
...
class CreateVersionView extends Component {
    static propTypes = {
        ...
        versionBaseId: PropTypes.string,
    ...
    handleSubmitForm = () => {
        ...
        submitNewVersion({
            ...
            baseVersionId: versionBaseId || null,
            history: history
        });
    };
