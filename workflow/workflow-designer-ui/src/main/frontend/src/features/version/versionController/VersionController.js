...
import { getVersionsList } from './versionControllerSelectors';
import VersionControllerView from './VersionControllerView';
...
function mapStateToProps(state) {
    return {
        ...
        currentWorkflowVersion: state.workflow.currentVersion.id
    };
}
