...
import { saveParamsAction } from 'features/version/versionController/versionControllerConstants';
import { getIsCurrentVersionsCertified } from 'features/version/general/generalSelectors';
...
function mapStateToProps(state) {
    return {
        ...
        isVersionsCertified: getIsCurrentVersionsCertified(state)
    };
}
