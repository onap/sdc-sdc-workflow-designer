...
import { sort, scroll } from './catalogReducer';
import { getSort, getWorkflows } from './catalogSelectors';
...
import { clearWorkflowAction } from '../workflow/workflowConstants';
