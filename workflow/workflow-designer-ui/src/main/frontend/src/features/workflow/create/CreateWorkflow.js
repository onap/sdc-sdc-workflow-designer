...
import { i18nSelector } from 'src/appSelectors';
import { hideModalAction } from 'shared/modal/modalWrapperActions';
import CreateWorkflowView from './CreateWorkflowView';
import { getWorkflowParams } from './createWorkflowSelector';
import { getWorkflowDescription, getWorkflowName } from '../workflowSelectors';
import {
    inputChangeAction,
    submitWorkflowAction
} from './createWorkflowConstants';
