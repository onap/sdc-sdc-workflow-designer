...
import {
    ...
    getWorkflowData,
    getIsVersionsCertifies
} from './overviewSelectors';
import {
    getVersionsAction,
    updateWorkflowAction,
    selectVersionAction
} from './overviewConstansts';
...
import { inputChangeAction } from '../create/createWorkflowConstants';
...
function mapStateToProps(state) {
    return {
        ...
        isVersionsCertifies: getIsVersionsCertifies(state)
    };
}
