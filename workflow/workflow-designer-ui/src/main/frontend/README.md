...
- [Syntax Highlighting in the CompositionView](#syntax-highlighting-in-the-editor)
- [Displaying Lint Output in the CompositionView](#displaying-lint-output-in-the-editor)
- [Debugging in the CompositionView](#debugging-in-the-editor)
...
- [Running Tests](#running-tests)
  ...
  - [CompositionView Integration](#editor-integration)
...
## Syntax Highlighting in the CompositionView

To configure the syntax highlighting in your favorite text editor, head to the [relevant Babel documentation page](https://babeljs.io/docs/editors) and follow the instructions. Some of the most popular editors are covered.

## Displaying Lint Output in the CompositionView
...
## Debugging in the CompositionView
...
Next you might want to integrate Prettier in your favorite editor. Read the section on [CompositionView Integration](https://prettier.io/docs/en/editors.html) on the Prettier GitHub page.
...
* Some editors like Vim and IntelliJ have a “safe write” feature that currently breaks the watcher. You will need to disable it. Follow the instructions in [“Adjusting Your Text CompositionView”](https://webpack.js.org/guides/development/#adjusting-your-text-editor).
