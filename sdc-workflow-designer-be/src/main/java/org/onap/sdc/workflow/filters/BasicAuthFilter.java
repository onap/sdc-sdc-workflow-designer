...
public class BasicAuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain arg2)
        ...
        if (basicAuthCredential == null || basicAuthCredential.isEmpty()) {
            arg2.doFilter(servletRequest, arg1);
            return;
        }

        if (basicAuthExcludedUrls != null && !basicAuthExcludedUrls.isEmpty()) {
        ...
        String authorizationHeader = httpRequest.getHeader(HttpHeader.AUTHORIZATION.asString());
        if (authorizationHeader == null || authorizationHeader.isEmpty()
            || !authorizationHeader.equals("Basic " + basicAuthCredential)) {
