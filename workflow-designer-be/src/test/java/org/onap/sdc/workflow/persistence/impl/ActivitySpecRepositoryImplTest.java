...
public class ActivitySpecRepositoryImplTest {
    ...
    public void testCreate() {
        ...
        Optional<ElementInfo> testElementInfo =
                zusammenAdaptor.getElementInfoByName(context, elementContext, Id.ZERO, ActivitySpecElementType.ACTIVITYSPEC.name());
        ...
        Assert.assertEquals(testElementInfo.get().getInfo().getProperty(
                ActivitySpecRepositoryImpl.InfoPropertyName.DESCRIPTION.getValue()), entity.getDescription());
