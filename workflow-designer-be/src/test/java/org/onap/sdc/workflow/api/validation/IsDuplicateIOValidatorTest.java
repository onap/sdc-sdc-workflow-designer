...
public class IsDuplicateIOValidatorTest {
    ...
    IsDuplicateIOValidator ioValidator;
    ...
    private IsDuplicateIOValidator initializeValidator(Class<?> classWithAnnotation) throws NoSuchFieldException {
        IsDuplicateIO constraint = classWithAnnotation.getField("workflowVersion").getAnnotation(IsDuplicateIO.class);
        IsDuplicateIOValidator validator = new IsDuplicateIOValidator();
