...
public class WorkflowManagerTest {
    ...
    private static final String ITEM2_ID = "item_id_2";
    ...
    private Workflow createWorkflow(int workflowNum, boolean setId){
        Workflow workflow = new Workflow();
        if(setId) {
            workflow.setId("item_id_" + workflowNum);
        }
        workflow.setCategory("category_" + workflowNum);
