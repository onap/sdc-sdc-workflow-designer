    ...
    public void updateState(String workflowId, String versionId, WorkflowVersionState newState) {
        ...
        if (newState == CERTIFIED) {
            if(!artifactRepository.isExist(workflowId,versionId)){
                throw new VersionStateModificationException(workflowId, versionId, currentState, newState, null,
                        true);
            }
            try {
                ...
                throw new VersionStateModificationException(workflowId, versionId, currentState,
                        newState, submitException, false);
            }
        } else {
