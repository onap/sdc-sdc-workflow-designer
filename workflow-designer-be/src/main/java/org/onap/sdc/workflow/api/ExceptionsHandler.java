...
public class ExceptionsHandler extends ResponseEntityExceptionHandler {
    ...
    private static final UnexpectedExceptionMapper UNEXPECTED_EXCEPTION_MAPPER =
            Boolean.FALSE.toString().equalsIgnoreCase(System.getProperty("errors.includeDevInfo"))
                    ? new UnexpectedExceptionMapperImpl()
                    : new UnexpectedExceptionMapperVerboseImpl();
    ...
    private static class UnexpectedExceptionMapperVerboseImpl extends UnexpectedExceptionMapperImpl {
