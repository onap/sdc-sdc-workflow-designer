...
var triggerClickEvent = require('bpmn-js-properties-panel/lib/Utils')
    .triggerClickEvent;

var implementationType = require('bpmn-js-properties-panel/lib/provider/camunda/parts/implementation/ImplementationType'),
    delegate = require('bpmn-js-properties-panel/lib/provider/camunda/parts/implementation/Delegate'),
        ...
        entryFactory.link({
            ...
            showLink: function(element, node) {
                ...
                if (isConnector(element)) {
                    var connectorId = InputOutputHelper.getConnector(
                        element
                    ).get('connectorId');
                    if (connectorId) {
                        ...
                        link.innerHTML =
                            '<span class="bpp-icon-warning"></span> Must configure Connector';
