...
public class Bpmn4ToscaJsonParser {
  ...
  private RestServiceTask createRestServiceTask(String jsonObject)
      throws JsonParseException, JsonMappingException, IOException {
    ...
    if (restConfig != null) { // while create a new rest task and didnot set method, the restconfig
                              // info may be null
      ...
      restServiceTask
          .setServiceVersion(getValueFromJsonNode(restConfig, JsonKeys.MICROSERVICE_VERSION));
    }
